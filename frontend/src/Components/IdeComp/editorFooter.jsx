    ...
    axios
      ...
      .then((res) => {
        navigator.clipboard.writeText(
          window.location.href + res.data.response._id
        );
    ...
    >
      <div className="side_footer">
        ...
        <span className="footer_text l_footer">
          ...
          <span className="file-name" onClick={ChangeFileName}>
            {fileName + extension[editorLang]}
          </span>
        </span>
        ...
        <span className="footer_text l_footer change_lang">
          ...
          <select
            name="language"
            id="language"
            onClick={(e) => changeLangFunc(e.target.value)}
          ></select>
        </span>
      </div>
      <div className="side_footer">
        <span
          className="footer_text r_footer line-col-num"
